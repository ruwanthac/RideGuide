...
const FLOW = ['requested', 'driver_picked_hire', 'driver_on_the_way', 'driver_arrived', 'vehicle_in_tow', 'completed'];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        <Text style={styles.title}>Tow tracking</Text>
        <Text style={styles.subtitle}>{request.pickupAddress || request.location} → {request.dropoffAddress || request.location}</Text>
